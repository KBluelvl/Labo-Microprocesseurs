...
_start:
    ...
    ; chez moi s = 0x402000 ce qui aboutit à copier  dans r10b
    ...
    ; par rbx, donc de la chaîne s, ce qui aboutit à copier 
    ; dans r14b
    mov     r14b, [rbx + rax]
    ...
    ; écriture du caractère  dans le 1er byte de msg
    ; [déplacement]
    mov     byte [msg], 

    ; écriture du caractère  dans le 2e byte de msg
    ; [déplacement] : pas d'indice ici car nasm réalise le calcul
    ;                 (somme de 2 immédiats) lors de l'assemblage
    mov     byte [msg + 1], 

    ; écriture du caractère  dans le 3e byte (indice 2) de msg
    ; [déplacement + indice] : ici facteur d'échelle vaut 1
    mov     r8, 2                   ; r8 : indice
    mov     byte [msg + r8], 

    ; écriture du caractère  dans le 4e byte (indice 3) de msg
